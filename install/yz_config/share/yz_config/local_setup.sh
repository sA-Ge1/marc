...
: ${AMENT_CURRENT_PREFIX:="/home/sage/marc_ws/install/yz_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yz_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yz_config/environment/path.sh"
